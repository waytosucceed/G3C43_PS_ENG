...
function loadQuestion(index) {
  ...
  if (previouslySelected !== null && previouslySelected !== undefined) {
    ...
    // // Show or hide the story button based on the current question index
    // var storyButton = document.getElementById("storyButton");
    // if (index < 5) {
    //     storyButton.style.display = "none"; // Hide button for the first 5 questions
    // } else {
    //     storyButton.style.display = "inline-block"; // Show button for questions 6 and beyond
    // }
